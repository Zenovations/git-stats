...
function StatsBuilder(conf) {
   ...
   //todo
   //todo retrieve cache
   //todo accumulate files
   //todo accumulate commits
   //todo
}

StatsBuilder.prototype.ready = function() {
   return this.defer.promise;
};

StatsBuilder.prototype.out = function(format, destination, compressed) {

};

exports.load = function(conf) {
   return new StatsBuilder(conf).ready();
};
